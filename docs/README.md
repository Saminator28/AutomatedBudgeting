...
Welcome to the Automated Budgeting documentation.
...
|---|---|
| [README.md](../README.md) | Getting started — install, run, and use the dashboard |
...
| Document | Description |
|---|---|
| [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md) | Full development setup, project structure, and contribution guide |
