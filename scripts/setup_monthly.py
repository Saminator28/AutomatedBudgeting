...
def extract_date_from_filename(filename: str):
    ...
    # Look for patterns like YYYY-MM-DD or statement_YYYY-MM-DD
...
def main():
    ...
    if not pdf_files:
        ...
        print("\nExample:")
        print("  mkdir -p statements/YYYY-MM")
        print("  mv statement.pdf statements/YYYY-MM/")
        print("  python process_monthly.py --month YYYY-MM")
        return
